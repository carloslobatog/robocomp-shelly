...
/** \mainpage RoboComp::teclado
 *
 * \section intro_sec Introduction
 *
 * The teclado component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/teclado --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class teclado : public RoboComp::Application
{
public:
	teclado (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::teclado::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
