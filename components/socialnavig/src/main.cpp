...
/** \mainpage RoboComp::socialnavig
 *
 * \section intro_sec Introduction
 *
 * The socialnavig component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/socialnavig --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class socialnavig : public RoboComp::Application
{
public:
	socialnavig (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::socialnavig::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
