...
/** \mainpage RoboComp::fakeHumanAgent4
 *
 * \section intro_sec Introduction
 *
 * The fakeHumanAgent4 component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/fakeHumanAgent4 --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class fakeHumanAgent4 : public RoboComp::Application
{
public:
	fakeHumanAgent4 (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::fakeHumanAgent4::initialize()
{
...
int ::fakeHumanAgent4::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
