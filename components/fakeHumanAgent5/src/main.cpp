...
/** \mainpage RoboComp::fakeHumanAgent5
 *
 * \section intro_sec Introduction
 *
 * The fakeHumanAgent5 component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/fakeHumanAgent5 --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class fakeHumanAgent5 : public RoboComp::Application
{
public:
	fakeHumanAgent5 (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::fakeHumanAgent5::initialize()
{
...
int ::fakeHumanAgent5::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
