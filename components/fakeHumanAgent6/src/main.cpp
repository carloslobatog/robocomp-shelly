...
/** \mainpage RoboComp::fakeHumanAgent6
 *
 * \section intro_sec Introduction
 *
 * The fakeHumanAgent6 component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/fakeHumanAgent6 --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class fakeHumanAgent6 : public RoboComp::Application
{
public:
	fakeHumanAgent6 (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::fakeHumanAgent6::initialize()
{
...
int ::fakeHumanAgent6::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
